...
insert into AvgSalary values (1001,'Surya','jothika','suryajothika@gmail.com','2010-04-22','AD_VP',25000,0.12,50,150,'9600204712')
insert into AvgSalary (FirstName,LastName,Email,HireDate,JobId,Salary,CommissionPct,ManagerId,DepartmentId,PhoneNumber)
...
select JobId, COUNT(*) as count, avg(salary) as average_salary from AvgSalary group by JobId